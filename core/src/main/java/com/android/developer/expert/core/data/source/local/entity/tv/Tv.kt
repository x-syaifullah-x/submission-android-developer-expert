...
class Tv(
    ...
    override fun homepage(): String? = tvEntity.homepage
    override fun originalLanguage(): String = tvEntity.originalLanguage
    override fun overview(): String = tvEntity.overview
    override fun popularity(): Double = tvEntity.popularity
    override fun posterPath(): String? = tvEntity.posterPath
    override fun status(): String = tvEntity.status
    override fun tagLine(): String? = tvEntity.tagLine
    override fun voteAverage(): Float = tvEntity.voteAverage
    override fun voteCount(): Int = tvEntity.voteCount
